...
for i in range(6):
    ...
    i = "sega_315-5571_xpol/instructions_%02d.png" % i
...
for x in range(32):
    print("Col %u / %u" % (x + 1, 32))
    for y in range(32):
        imageName = "sega_315-5571_xpol/sega_315-5571_xpol_%02d_%02d.png" % (x, y)
